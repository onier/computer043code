...
class AnimationCanvas extends JLabel implements Runnable {
    ...
    AnimationCanvas() {
        ...
        setSize(450, 400);
        try {
            image = new javax.swing.ImageIcon(new URL("http://news.xinhuanet.com/mil/2010-11/18/12790465_31n.jpg")).getImage();
        } catch (MalformedURLException ex) {
            Logger.getLogger(AnimationCanvas.class.getName()).log(Level.SEVERE, null, ex);
        }
