...
public class ImageO extends JApplet {
    ...
    public void init() {
        ...
        for (int i = 0; i < bi.length; i++) {
            try {
                Image img = new javax.swing.ImageIcon(new URL("http://news.xinhuanet.com/mil/2010-11/18/12790465_31n.jpg")).getImage();
                try {
                ...
                Logger.getLogger(ImageO.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
