...
public class ConvolveIt extends JFrame {
    ...
    public Image getImage(String imageFile) {
        try {
            return new javax.swing.ImageIcon(new URL("http://news.xinhuanet.com/mil/2010-11/18/12790465_31n.jpg")).getImage();
        } catch (MalformedURLException ex) {
            Logger.getLogger(ConvolveIt.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
