 ...
 * @author Jeff Shapiro
 */
public class ColorToolBarUI extends ToolBarUI implements SwingConstants {
    ...
    protected void installKeyboardActions() {
        ...
        LazyActionMap.installLazyActionMap(toolBar, ColorToolBarUI.class,
                "ToolBar.actionMap");
    }
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            ColorToolBarUI ui = (ColorToolBarUI) getUIOfType(
                    toolBar.getUI(), ColorToolBarUI.class);
