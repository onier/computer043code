 ...
 * @author Dave Moore
 */
public class ColorTabbedPaneUI extends TabbedPaneUI implements SwingConstants {
...
// UI Installation/De-installation
    ...
    protected JButton createScrollButton(int direction) {
        ...
        return new ColorArrowButton(direction);
    }
    ...
    protected void installKeyboardActions() {
        ...
        LazyActionMap.installLazyActionMap(tabPane, ColorTabbedPaneUI.class,
...
// Tab Navigation methods
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            ColorTabbedPaneUI ui = (ColorTabbedPaneUI) getUIOfType(pane.getUI(), ColorTabbedPaneUI.class);
    ...
    public class TabbedPaneLayout implements LayoutManager {
        ...
        private void layoutTabComponents() {
            ...
            for (int i = 0; i < tabPane.getTabCount(); i++) {
                ...
                y = y + getTabLabelShiftY(tabPlacement, i, isSeleceted);
                x = x + getTabLabelShiftX(tabPlacement, i, isSeleceted);
                c.setBounds(x, y, preferredSize.width, tabContainer.getHeight());
            }
        }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (map != null) {
                ...
                if (e.getSource() == scrollForwardButton) {
                    ...
                    tabScroller.scrollBackward(tabPane.getTabPlacement());
                }
...
//                }
    ...
    private class ScrollableTabPanel extends JComponent implements UIResource {
        ...
        public void paintComponent(Graphics g) {
            ...
            ColorTabbedPaneUI.this.paintTabArea(g, tabPane.getTabPlacement(),
...
// Controller: event listeners
    private class Handler implements ChangeListener, ContainerListener,
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (name == "mnemonicAt") {
                ...
                ColorTabbedPaneUI.this.uninstallUI(pane);
                ColorTabbedPaneUI.this.installUI(pane);
                calculatedBaseline = false;
    ...
    private class TabContainer extends JComponent implements UIResource {
        ...
        public void paint(Graphics g) {
            ...
            g2d.setPaint(new GradientPaint(0, 0, new Color(191, 219, 255), 0, this.getHeight(), new Color(191, 219, 255)));
    ...
    private class CroppedEdge extends JComponent implements UIResource {
