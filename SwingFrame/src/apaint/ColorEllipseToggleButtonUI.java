 ...
 * @author admin
 */
public class ColorEllipseToggleButtonUI extends BasicToggleButtonUI {

    private final static ColorEllipseToggleButtonUI toggleButtonUI = new ColorEllipseToggleButtonUI();
